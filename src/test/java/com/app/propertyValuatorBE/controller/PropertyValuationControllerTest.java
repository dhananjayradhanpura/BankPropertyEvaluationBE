...
import com.app.propertyValuatorBE.apiManager.PropertyValuationApi;
...
@WebMvcTest(PropertyValuationApi.class)
public class PropertyValuationControllerTest {
    ...
    @InjectMocks
    private PropertyValuationApi propertyValuationController;
