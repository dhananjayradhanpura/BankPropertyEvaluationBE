...
@WebMvcTest(com.app.propertyValuatorBE.apiManager.AuthApi.class)
public class AuthApiTest {
    ...
    @InjectMocks
    private com.app.propertyValuatorBE.apiManager.AuthApi authApi;
    ...
    public void setup() {
        ...
        this.mockMvc = MockMvcBuilders.standaloneSetup(authApi).build();
    }
